...
class Test_BaseModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_args = {'created_at': datetime(2020, 3, 11, 3, 7, 56, 369959),
                     'updated_at': datetime(2020, 3, 11, 3, 7, 56, 365977),
    ...
    def test_reinstantiation(self):
        ...
        self.assertEqual(self.model2.created_at,
                         datetime(2020, 3, 11, 3, 7, 56, 369959))
    ...
    def test_to_json(self):
        ...
        self.assertEqual(jsonified["created_at"], '2020-02-10 02:06:55.258849')
